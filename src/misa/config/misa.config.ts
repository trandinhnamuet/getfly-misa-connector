export const MISA_CONFIG = {
  ...
  default_branch_id: 'd501cc43-326d-47a8-8286-a1fae4e23263',
  default_organization_unit_id: 'f5e41242-bbc2-4d64-931d-4996ba1b4857',
...
export const GETFLY_CONFIG = {
  base_url: 'https://hoanggiahp.getflycrm.com',
  api_key: 'KKIAZXscIPdDeQoq1ak7N9BTcrcv1r',
  order_fields: 'id,order_code,real_amount,f_amount,discount,discount_amount,vat_amount,account_id,account_code,account_email,account_phone,account_address,order_date,status,contact_name,contact_phone,contact_email,order_details'
};
...
export const DATA_FILES = {
  ...
  inventory: './data/misa_inventory.txt'
};